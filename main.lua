...
local function makePiece(id, isShadow)
    local piece = {}
    piece.squares = {}
...
local function makeRotatedPiece(piece, direction)
...
local function drawCurrentPiece(fieldOffsetX, fieldOffsetY)
    love.graphics.push()
